...
export class PurchaseInvoiceDetailController {
  ...
  async create(
    ...
    return this.detailService.createDetail(invoiceID, productID, quantity, unitPrice);
  }
  ...
  @Put(':id')
  async update(@Param('id') id: number, @Body('quantity') quantity: number): Promise<void> {
